...
public class UpdateOrDeleteEventFragment extends DialogFragment {

    public static UpdateOrDeleteEventFragment getInstance() {

        return new UpdateOrDeleteEventFragment();
    }

    public UpdateOrDeleteEventFragment() {
    ...
    public static final String TAG = "UPDATE_OR_DELETE_EVENT";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_or_delete_event, container, false);
        ...
        event = DataHolder.getInstance().getEvent();


        title.setText(event.getName());
        description.setText(event.getDescription());
        info.setText(event.getDate_debut());
